...
echo "========================================="
echo " CLIP-ReID GRID RUNNER (SIE+OLP)"
...
SEEDS_STR="${SEEDS_STR:-"1234 2345 3456"}"
...
run_one () {
  ...
  local output_dir="${OUTPUT_ROOT}/vit_clipreid_sie_olp_${dataset_name}_seed${seed}_pct${pct_tag}"
