...
echo "========================================="
echo " CLIP-ReID MULTI-GRANULARITY RUNNER"
echo " Market1501  ->  MSMT17 (STRICT)"
echo "========================================="

DATA_ROOT="/root/autodl-tmp/CLIP_REID/DATASETS"
OUTPUT_ROOT="/root/autodl-tmp/CLIP_REID/OUTPUT/multi_granularity"
...
############################################
run_dataset "market1501" "${OUTPUT_ROOT}/market1501" "${OUTPUT_ROOT}/tensorboard/market1501"
echo "[INFO] Market1501 DONE. Proceeding to MSMT17."

run_dataset "msmt17" "${OUTPUT_ROOT}/msmt17" "${OUTPUT_ROOT}/tensorboard/msmt17"
